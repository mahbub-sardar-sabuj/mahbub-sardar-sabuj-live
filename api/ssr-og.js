...
const newsData = [
  { id: 27, title: "সত্য ও ন্যায়ের পথে অবিচল: সরদার সংবাদের অঙ্গীকার", excerpt: "বর্তমান সময়ের তথ্যপ্রবাহে সত্য ও নিরপেক্ষ সংবাদ পৌঁছে দেওয়া একটি বড় দায়িত্ব। এই দায়িত্ববোধ থেকেই পথচলা শুরু করেছে সরদার সংবাদ।", image: `${SITE_URL}/images/news/sardar-sangbad-mission.png` },
  { id: 26, title: "ভালোবাসা, বেদনা ও নিঃশব্দ অনুভূতির ভাষায় মুরাদ হাসানের কবিতা", excerpt: "চট্টগ্রামের সাতকানিয়া উপজেলার তরুণ কবি মুরাদ হাসান নীরব অনুভূতি আর না-বলা কথাগুলোকে কবিতার ভাষায় প্রকাশ করে ধীরে ধীরে পাঠকের দৃষ্টি আকর্ষণ করছেন।", image: `${SITE_URL}/images/news/murad-hasan-poet.png` },
  { id: 25, title: "ভোলা থেকে উঠে আসা নতুন সাহিত্যকণ্ঠ আকিবুল হাসান", excerpt: "ভালোবাসা, বেদনা আর জীবনের গভীর অনুভূতি—এই তিনটিকেই শব্দে রূপ দিতে ভালোবাসেন তরুণ লেখক আকিবুল হাসান।", image: `${SITE_URL}/images/news/akibul-hasan.png` },
  { id: 24, title: "হাতকড়ায় চেয়ারম্যান: খোশবাসে বেদনা, অনিশ্চয়তায় জনজীবন", excerpt: "কুমিল্লার বরুড়া উপজেলার খোশবাস ইউনিয়নে চেয়ারম্যান নাজমুল হাসান সর্দারের গ্রেফতারের ঘটনায় জনজীবনে নেমে এসেছে অনিশ্চয়তা ও উদ্বেগ।", image: `${SITE_URL}/images/news/khoshbash-chairman-v2.png` },
  { id: 21, title: "উদীয়মান তরুণ কবি জাহিদ হাসান—ভালোবাসা, বেদনা ও অনুভূতির কণ্ঠস্বর", excerpt: "ময়মনসিংহের চর-ঝাউগড়া গ্রামের নীরব পরিবেশ থেকে উঠে আসা তরুণ লেখক জাহিদ হাসান ধীরে ধীরে নিজস্ব সাহিত্যভুবন গড়ে তুলছেন।", image: `${SITE_URL}/images/news/zahid-hasan-poet.png` },
  { id: 20, title: "নতুন আঙ্গিকে সাহিত্যচর্চা: চালু হলো লেখক মাহবুব সরদার সবুজের অফিসিয়াল ওয়েবসাইট", excerpt: "ডিজিটাল যুগের সঙ্গে তাল মিলিয়ে সাহিত্যকে আরও সহজলভ্য ও সংগঠিত করতে লেখক মাহবুব সরদার সবুজ তার নতুন অফিসিয়াল ওয়েবসাইট চালু করেছেন।", image: `${SITE_URL}/images/news/website-launch.png` },
  { id: 19, title: "১১০ হাজার ফলোয়ার পূর্ণ: কৃতজ্ঞতা জানালেন লেখক মাহবুব সরদার সবুজ", excerpt: "জনপ্রিয় লেখক মাহবুব সরদার সবুজের অফিসিয়াল প্রোফাইল আইডিতে ফলোয়ার সংখ্যা ১১০ হাজারে পৌঁছেছে।", image: `${SITE_URL}/images/news/110k-followers.png` },
  { id: 18, title: '"ডিসেম্বরের শহরে" বই নিয়ে পাঠকমহলে আগ্রহ বাড়ছে', excerpt: 'বাংলা সাহিত্য অঙ্গনে সমকালীন রোমান্টিক ধারার আলোচিত বইগুলোর মধ্যে জায়গা করে নিয়েছে "ডিসেম্বরের শহরে"।', image: `${SITE_URL}/images/news/december-shohor.png` },
  { id: 17, title: "আপনার গল্প, আপনার পরিচিতি—এবার বৃহৎ পাঠকের কাছে", excerpt: "ডিজিটাল এই সময়ে নিজের পরিচিতি তুলে ধরা কিংবা ব্যক্তিগত সাফল্যের গল্প শেয়ার করা এখন অনেক সহজ।", image: `${SITE_URL}/images/news/platform-announcement.png` },
  { id: 10, title: "ঢাকা বাতিঘরে তরুণ আবৃত্তিকারদের বই-পরিচিতি", excerpt: 'তরুণ আবৃত্তিকার মরিয়ম ও সোহানী ঢাকা বাতিঘরে মাহবুব সরদার সবুজের বই "আমি বিচ্ছেদকে বলি দুঃখবিলাস"-এর সাথে পরিচিত হন।', image: `${SITE_URL}/images/news/baighar-visit.png` },
];
