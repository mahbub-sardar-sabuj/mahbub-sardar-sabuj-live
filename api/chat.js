...
function buildFallbackReply(messages = [], aiError = null) {
  ...
  if (/পারবেন না|সীমাবদ্ধতা|limitation|কি পারেন|কী পারেন|কি করতে পারো|কী করতে পারো|কি কি করতে পারো|কী কী করতে পারো|cannot|can't|can you do|what can you do/.test(q)) {
