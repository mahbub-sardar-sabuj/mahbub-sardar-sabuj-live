      ...
      <main style={{ paddingTop: 120, paddingBottom: 72 }}>
        <section style={sectionStyle}>
          ...
          <article style={cardStyle}>
            <p style={pStyle}>
              মাহবুব সরদার সবুজ-এর সঙ্গে যোগাযোগের সবচেয়ে উপযুক্ত মাধ্যম হলো ইমেইল এবং অফিসিয়াল সামাজিক মাধ্যম প্রোফাইল। সাহিত্য, প্রকাশনা, বই, আবৃত্তি, পাঠ-প্রতিক্রিয়া, অথবা অন্য যেকোনো গঠনমূলক বিষয়ে যোগাযোগ করা যেতে পারে।
            </p>
