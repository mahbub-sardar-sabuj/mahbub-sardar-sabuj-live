      ...
      <main style={{ paddingTop: 120, paddingBottom: 72 }}>
        <section style={sectionStyle}>
          ...
          <article style={cardStyle}>
            ...
            <p style={pStyle}>
             এই ওয়েবসাইট মূলত সাহিত্য, ব্যক্তিগত পরিচিতি, প্রকাশিত বই, এবং পাঠকসংযোগমূলক তথ্য প্রদানের জন্য নির্মিত। এখানে প্রকাশিত তথ্যকে আইনগত, আর্থিক, চিকিৎসা, বা অন্য কোনো পেশাগত পরামর্শ হিসেবে গণ্য করা যাবে না।
            </p>
