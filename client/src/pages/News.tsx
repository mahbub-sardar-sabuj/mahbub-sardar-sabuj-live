...
const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    content: "মাহবুব সরদার সবুজের চারটি ই-বুক — \"আমি বিচ্ছেদকে বলি দুঃখবিলাস\", \"স্মৃতির বসন্তে তুমি\", \"চাঁদফুল\" এবং \"সময়ের গহ্বরে\" — এখন ওয়েবসাইটে বিনামূল্যে পড়া যাচ্ছে। পাঠকরা যেকোনো ডিভাইস থেকে সহজেই এই বইগুলো পড়তে পারবেন।",
    category: "ই-বুক",
