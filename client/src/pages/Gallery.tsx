              ...
              <div style={{ textAlign: "center", marginTop: "1rem" }}>
                ...
                <div style={{ display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap" }}>
                  ...
                  <a
                    ...
                    onClick={(e) => e.stopPropagation()}
                    style={{ display: "flex", alignItems: "center", gap: 6, padding: "6px 14px", borderRadius: 999, background: "rgba(24,119,242,0.12)", border: "1px solid rgba(24,119,242,0.3)", color: "#1877F2", fontFamily: "'AdorshoLipi', sans-serif", fontSize: "0.75rem", textDecoration: "none" }}
                  >
