          ...
          <div style={{ display: "grid", gap: 20 }}>
            ...
            >
              ...
              <p style={{
                ...
                এই টুলটি Google Gemini AI ব্যবহার করে মানুষের মতো স্বাভাবিক কণ্ঠে বাংলা পড়তে পারে। সর্বোচ্চ {MAX_CHARS.toLocaleString()} অক্ষর পর্যন্ত একসাথে আবৃত্তি করা যাবে। অডিও WAV ফরম্যাটে ডাউনলোড হবে।
              </p>
            </motion.div>
