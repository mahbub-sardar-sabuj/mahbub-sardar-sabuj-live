...
const CSS = `
  ...
  @media(max-width:620px){.bk-page{background:linear-gradient(155deg,#f8fbff,#e8f0fb)}.bk-hero{border-radius:24px}.bk-hero h1{font-size:2.32rem}.bk-hero p{font-size:1rem}.bk-head h2{font-size:1.72rem}.bk-guide-item strong{font-size:.9rem}.bk-card p{font-size:.86rem}.bk-feature-note p{font-size:.95rem}}
`;
...
export default function EBooks() {
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 16px 28px", background: "#eef3fa" }}><AdSenseAd adSlot={AD_SLOTS.EBOOKS_SIDEBAR} adFormat="auto" fullWidthResponsive /></div>
      <Footer />
